This is the MEDIAL filter plugin for Moodle 3.x and better.

Installation
------------

1 - Copy the contents of the zip file which contains this readme.txt into the moodle/filter directory of your
    Moodle installation.
